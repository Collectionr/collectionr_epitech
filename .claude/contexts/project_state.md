...
_Dernière mise à jour : 2026-09-17 (COLLR-437 — installation Prisma/PostgreSQL)_
...
- **COLLR-412** — Setup base de données (outillage Prisma/PostgreSQL). COLLR-437 fait (ci-dessus). Restent **COLLR-438** (script de seed) et **COLLR-439** (revue finale migrations/indexation — explicitement à faire en dernier, une fois les epics fonctionnels terminés).
