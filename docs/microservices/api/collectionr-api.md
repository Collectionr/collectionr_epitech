...
- **prix** collectés via la cascade TCGdex (niv. 1) → PokeTrace (niv. 2) → eBay Browse API (niv. 3)
  → TCGFast (niv. 4) (cf. [marketplace-scraper.md](../marketplace/marketplace-scraper.md)).
