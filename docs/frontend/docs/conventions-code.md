...
- [composants.md](./composants.md) -- Template de composant et structure de fichiers
- [data-et-etat.md](./data-et-etat.md) -- Zustand, TanStack Query et regles de decision
- [CONTRIBUTING.md (global)](../../CONTRIBUTING.md) -- Checklist avant Pull Request et strategie de tests
- [design-system.md](./design-system.md) -- Tokens de design et animations
