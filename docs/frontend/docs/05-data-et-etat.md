...
- [04-conventions-code.md](./04-conventions-code.md) -- Regles TypeScript pour les types des stores et services
- [03-composants.md](./03-composants.md) -- Skeleton loaders pour les etats de chargement
- [01-architecture.md](./01-architecture.md) -- Placement des fichiers stores, hooks et services
- [06-contributing.md](./06-contributing.md) -- Tests des hooks et stores
