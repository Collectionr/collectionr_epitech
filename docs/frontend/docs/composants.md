...
- [design-system.md](./design-system.md) -- Tokens de couleur, espacement, typographie et animations
- [conventions-code.md](./conventions-code.md) -- Regles TypeScript et imports
- [data-et-etat.md](./data-et-etat.md) -- Hooks TanStack Query et stores Zustand
- [architecture.md](./architecture.md) -- Structure des dossiers et placement des composants
